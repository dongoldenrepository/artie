#!/bin/bash
# Sets admin_password (MyArtie2026) in all 4 D1 databases
# and MASTER_PASSWORD (Galatians0522) as a Pages secret on all 4 projects.
...
echo ""
echo "=== Setting MASTER_PASSWORD secret on all 4 Pages projects ==="
